...
import com.space.controlador.Controller;
import com.space.modelo.Bullet;
import com.space.modelo.Enemy;
...
public class Game extends JPanel implements ActionListener {
    ...
    public Game() {
        ...
        ImageIcon referencia = new ImageIcon(getClass().getResource("/com/space/recursos/fondo.png"));
    ...
    public void checkPlayer() {
        try {
            recp = Integer.parseInt(JOptionPane.showInputDialog(null, "<html>pulsa 1 para jugar solor<br>"
                    + "pulsa 2 para jugar con otra persona</html>", "tipo de juego", 1));
    ...
    private void initEnemy() {
        ...
        ProxyImage imagemInimigoUm = new ProxyImage("/com/space/recursos/enemigonuevo.PNG");
        ProxyImage imagemInimigoDois = new ProxyImage("/com/space/recursos/enemigonuevo2.PNG");
        for (int i = 0; i < 600; i++) {
        ...
        if (emJogo) {
            ...
            if (p2 == true) {
                if (naveDois.isMorto() == false) {
                    ImageIcon naveDois_ = new ImageIcon(getClass().getResource("/com/space/recursos/ship2.gif"));
            ...
            ImageIcon ganhojogo = new ImageIcon(getClass().getResource("/com/space/recursos/Instrucciones.png"));

            graficos.drawImage(ganhojogo.getImage(), 0, 0, null);

        } else if (inicio) {

            ImageIcon bg_ = new ImageIcon(getClass().getResource("/com/space/recursos/Pantallainicionuevo.png"));
            Inicio = bg_.getImage();
            graficos.drawImage(Inicio, 0, 0, null);

        } else {
            ImageIcon fimJogo = new ImageIcon(getClass().getResource("/com/space/recursos/resumen.png"));
